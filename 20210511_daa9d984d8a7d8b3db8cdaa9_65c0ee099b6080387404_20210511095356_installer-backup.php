...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210511_daa9d984d8a7d8b3db8cdaa9_65c0ee099b6080387404_20210511095356_archive.zip';
	const ARCHIVE_SIZE		 = '85701451';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '65c0ee0-11095356';
    const SECONDARY_PACKAGE_HASH = '0402a77-11095356';
	const VERSION			 = '1.4.0';
